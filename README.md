...
Portanto, para rodar os testes no GitHub Actions, realize uma alteração qualquer neste arquivo `README.md` (alteração) e faça o commit da alteração com a seguinte mensagem: `Commit 1: Running the tests`.
